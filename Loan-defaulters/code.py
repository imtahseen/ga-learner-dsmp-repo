...
X_train['int.rate']=(X_train['int.rate'].apply(lambda x:x.replace('%','')).astype('float'))/100
print(X_train['int.rate'])
X_test['int.rate']=(X_test['int.rate'].apply(lambda x:x.replace('%','')).astype('float'))/100
print(X_train['int.rate'])
...
fig , axes= plt.subplots(9,1, figsize=(5,15))
...
fig , axes= plt.subplots(2,2, figsize=(5,15))
